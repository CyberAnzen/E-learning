...
const RadialProgess = ({
  ...
  return (
    <div className="bg-transparent cyber-cart text-[#01ffdb] transition-all duration-300 hover:shadow-lg hover:shadow-[#01ffd922]  p-4 md:px-12 lg:px-10 flex flex-col md:flex-row justify-between items-center w-full">
