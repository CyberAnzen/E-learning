...
const RadialProgess = ({
  ...
  return (
    <div className="bg-[#0f172a]/50 text-white border-[#38bdf8]/20 backdrop-blur-xl rounded-xl border hover:border-cyan-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-cyan-500/10  p-4 md:px-12 lg:px-10 flex flex-col md:flex-row justify-between items-center w-full">
