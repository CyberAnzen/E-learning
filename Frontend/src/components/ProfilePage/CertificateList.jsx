  ...
  return (
    ...
    <div className="max-w-5xl mx-auto p-4 space-y-10 min-h-155 py-10">
      ...
      {courses.map((course, index) => (
        <div
          key={index}
          className="shadow-md rounded-lg p-4 flex flex-col md:flex-row justify-between items-start md:items-center space-y-4 md:space-y-0  bg-gray-800/50 border border-gray-700 hover:border-cyan-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-cyan-500/10"
        >
