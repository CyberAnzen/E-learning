...
import { Maximize2, Shield, X, Plus, Trash2, Save, Eye } from "lucide-react";
    ...
    <div className="bg-gradient-to-br from-gray-900 via-black mt-23 to-gray-900 min-h-screen p-5">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
          ...
          <div className="bg-gray-900/50 rounded-xl p-6 backdrop-blur-sm border border-cyan-500/30 shadow-2xl shadow-cyan-500/10">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                {formData.tasks.content.questions.map((question, qIndex) => (
                  <div
                    key={qIndex}
          ...
          {/* Live Preview - Cyberpunk Styled */}
          <div className="bg-gray-900/50 rounded-xl p-6 backdrop-blur-sm border border-purple-500/30 shadow-2xl shadow-purple-500/10">
            ...
            <div
              ref={sidePreviewRef}
              className="max-h-[80vh] overflow-y-auto bg-gray-900/20 rounded-lg border border-purple-500/20"
            >
              <Content
